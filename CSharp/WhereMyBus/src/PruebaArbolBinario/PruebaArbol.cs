...
namespace Tests.Arbol{
    public static class App{
        ...
        public static void Start(){
            ...
            Node z = new Node("[R] Z");
            Node aeropuerto = new Node("[P] Aeropuerto");
            Node santa = new Node("[P] Santa Anita Mall");
            Node loro = new Node("[R] El Loro");
            Node universitaria = new Node("[P] Universitaria");
            Node naranjal = new Node("[P] El Naranjal");
            caqueta.Add(chino);
            chino.Add(lima);
            lima.Add(z);
            z.Add(aeropuerto);
